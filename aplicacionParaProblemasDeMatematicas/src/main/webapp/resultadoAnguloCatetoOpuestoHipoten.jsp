...
<title>Resultado ángulo agudo, cateto opuesto e hipotenusa</title>
</head>
<body>
				<%
				...
				%>
					...
					<h3><%=OperacionesTrigonometria.devuelveAnguloCatetoOpHipotenusa(objetoDosDatos.getPrimerDato(), objetoDosDatos.getSegundoDato())%></h3>
</body>
</html>