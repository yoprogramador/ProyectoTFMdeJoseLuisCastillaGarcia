...
public class ReglaDeTresInversaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ReglaDeTresInversaServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/resultadoReglaDe3Inv.jsp");
