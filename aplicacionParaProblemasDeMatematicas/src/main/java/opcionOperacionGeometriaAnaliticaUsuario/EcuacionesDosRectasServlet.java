...
public class EcuacionesDosRectasServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public EcuacionesDosRectasServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/resultadoDistanciaDosRectas.jsp");
