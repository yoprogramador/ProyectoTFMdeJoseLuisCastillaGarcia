...
public class EcuacionesDosRectasBisServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public EcuacionesDosRectasBisServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/resultadoBisectrices.jsp");
