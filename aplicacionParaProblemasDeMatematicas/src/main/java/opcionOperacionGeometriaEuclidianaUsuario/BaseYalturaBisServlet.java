...
public class BaseYalturaBisServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public BaseYalturaBisServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/resultadoAreaTriang.jsp");
