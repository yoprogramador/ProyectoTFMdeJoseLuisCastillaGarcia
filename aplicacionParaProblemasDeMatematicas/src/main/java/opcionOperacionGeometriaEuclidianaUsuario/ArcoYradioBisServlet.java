...
public class ArcoYradioBisServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ArcoYradioBisServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/resultadoGradosAnguloBis.jsp");
