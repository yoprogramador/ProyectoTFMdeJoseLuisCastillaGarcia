...
public class AlturaYareaBisServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AlturaYareaBisServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/resultadoBaseTriang.jsp");
