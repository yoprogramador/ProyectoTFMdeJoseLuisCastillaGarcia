...
public class ArcoTangenteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ArcoTangenteServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/resultadoArcoTangente.jsp");
