...
<title>Resultado ángulos agudos e hipotenusa</title>
</head>
<body>
				<%
				...
				%>
					...
					<h3><%=OperacionesTrigonometria.devuelveDosAngulosHipotenusa(objetoDosDatos.getPrimerDato(), objetoDosDatos.getSegundoDato())%></h3>
</body>
</html>