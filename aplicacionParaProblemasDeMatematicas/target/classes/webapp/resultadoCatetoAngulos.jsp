...
<title>Resultado cateto y ángulos agudos</title>
</head>
<body>
				<%
				...
				%>
					...
					<h3><%=OperacionesTrigonometria.devuelveAngulosCateto(objetoDosDatos.getPrimerDato(), objetoDosDatos.getSegundoDato())%></h3>
</body>
</html>